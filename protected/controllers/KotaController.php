...
class KotaController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','daftarPropinsi','kotaMenurutProp'),
				'users'=>array('*'),
			),
	...
	/**
	 *
	 * Penambahan code daftarPropinsi
	 *
	 */

	public function actionDaftarPropinsi()
	{
		$model=new Provinsi;
		$this->render('daftarPropinsi',array(
			'model'=>$model,));
	}
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Kota']))
		{
			...
			if($model->save())
				//$this->redirect(array('kotaMenurutProp','propinsi_id'=>$idProp));
